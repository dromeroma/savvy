...
# Any authenticated POS user can read the catalog (listing locations, categories, products);
# mutations require products.manage.
...
@router.get(
    ...
    response_model=ProductResponse,
    dependencies=[Depends(require_permission("pos", "sales.create", "inventory.read"))],
)
