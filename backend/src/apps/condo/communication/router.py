...
router = APIRouter(
    ...
    tags=["Condo Communication"],
    dependencies=[Depends(require_permission("condo", "communication.manage", "reports.view"))],
)
...
@router.post(
    ...
    dependencies=[Depends(require_permission("condo", "communication.manage"))],
)
