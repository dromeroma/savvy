...
router = APIRouter(prefix="/products", tags=["Credit Products"])
...
@router.post("", response_model=CreditProductResponse, status_code=status.HTTP_201_CREATED)
...
@router.patch("/{product_id}", response_model=CreditProductResponse)
