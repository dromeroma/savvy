...
from src.apps.memorial.payments.service import PaymentsService
from src.core.dependencies import get_current_user, get_db, get_org_id
from src.modules.apps.permissions import require_permission

router = APIRouter(prefix="/payments", tags=["Memorial · Pagos"])
...
@router.get(
    ...
    dependencies=[Depends(require_permission(
        "memorial", "payments.read", "payments.manage",
    ))],
)
...
@router.post(
    ...
    dependencies=[Depends(require_permission("memorial", "payments.manage"))],
)
