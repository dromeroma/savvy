...
const APP_MENUS: Record<string, { icon: string; items: { label: string; route: string }[] }> = {
  church: {
    ...
    items: [
      ...
      { label: 'Doctrina', route: '/church/doctrine' },
      { label: 'Rotaciones', route: '/church/rotations' },
      { label: 'Ayuda Social', route: '/church/social-aid' },
  ...
  pos: {
    ...
    items: [
      ...
      { label: 'Sugerencias IA ✨', route: '/pos/insights' },
  ...
  memorial: {
    ...
    items: [
      ...
      { label: 'Riesgo de cartera ✨', route: '/memorial/risk' },
  ...
  hotel: {
    icon: `<svg class="size-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 20h20"/><path d="M4 20V7a1 1 0 0 1 1-1h6v14"/><path d="M13 20V10a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v10"/><path d="M7 9h.01M7 12h.01M7 15h.01"/></svg>`,
    items: [
      { label: 'Dashboard', route: '/hotel/dashboard' },
      { label: 'Reservas', route: '/hotel/reservations' },
      { label: 'Habitaciones', route: '/hotel/rooms' },
      { label: 'Housekeeping', route: '/hotel/housekeeping' },
    ],
  },
  hr: {
    icon: `<svg class="size-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/></svg>`,
    items: [
      { label: 'Dashboard', route: '/hr/dashboard' },
      { label: 'Empleados', route: '/hr/employees' },
      ...
      { label: 'Liquidaciones', route: '/hr/liquidations' },
      { label: 'Reportes', route: '/hr/reports' },
      { label: 'Configuración', route: '/hr/settings' },
    ],
  },
};
